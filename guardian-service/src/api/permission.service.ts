    ...
    ApiResponse(MessageAPI.CHECK_KEY_PERMISSIONS,
        async (msg: { did: string, keyType: KeyType, entityId: string, userId: string | null }) => {
            ...
            try {
                ...
                logger.info(`KEY_TYPE_KEY_ENTITY: ${JSON.stringify(KEY_TYPE_KEY_ENTITY)}`, ['GUARDIAN_SERVICE'], userId);
                ...
                switch (entity) {
                    ...
                    case KeyEntity.TOPIC: {
                        ...
                        logger.info(`Topic count DID: ${did} topicId: ${entityId} count: ${count}`, ['GUARDIAN_SERVICE'], userId);  
                        return new MessageResponse(
                            count > 0
                        );
                    }
