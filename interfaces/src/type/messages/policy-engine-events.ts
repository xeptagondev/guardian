...
export enum PolicyEngineEvents {
    ...
    CREATE_VIRTUAL_USER_V2 = 'policy-engine-event-create-virtual-user-V2',
    ...
    GET_MOCK_CONFIG = 'policy-engine-event-get-mock-config',
    GET_MOCK_DATA = 'policy-engine-event-get-mock-data',
    SET_MOCK_DATA = 'policy-engine-event-set-mock-data',
    SET_MOCK_CONFIG = 'policy-engine-event-set-mock-config',
    IMPORT_MOCK_DATA = 'policy-engine-event-import-mock-data',
    EXPORT_MOCK_DATA = 'policy-engine-event-export-mock-data',
    MOCK_REQUEST = 'policy-engine-event-mock-request',
    ...
    GET_MIGRATION_RUNS = 'policy-engine-event-get-migration-runs',
    ...
    EXECUTE_GRID_ACTION = 'policy-engine-event-execute-grid-action'
}
