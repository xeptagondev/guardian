...
<p align="center">
<img src="./Assets/Images/workflow/image1.png" alt="Policy Workflow"/>
</p>

## Step By Step

### Project Developer User Onboarding
* Create a new virtual user clicking **Create User** button.

<p align="center">
<img src="./Assets/Images/PD_Onboarding/image1.png" alt="Create User" width="700"/>
</p>

* elect the newly created virtual user from **Users** dropdown.
<p align="center">
<img src="./Assets/Images/PD_Onboarding/image2.png" alt="Select a User" width="700"/>
</p>

* Assign Project Developer role to the virtual user. 
<p align="center">
<img src="./Assets/Images/PD_Onboarding/image3.png" alt="Assign a role" width="700"/>
</p>

* Fill in the Project Developer User Onboarding form and submit it.
<p align="center">
<img src="./Assets/Images/PD_Onboarding/image4.png" alt="Fill in PD onboarding Schema" width="700"/>
<img src="./Assets/Images/PD_Onboarding/image5.png" alt="Submit PD onboarding Schema" width="700"/>
</p>

* You will then be directed to the **Waiting for Approval** page.
<p align="center">
<img src="./Assets/Images/PD_Onboarding/image6.png" alt="Waiting for Approval" width="700"/>
</p>

* From the **Users** dropdown, select **Administrator**.
<p align="center">
<img src="./Assets/Images/PD_Onboarding/image7.png" alt="Select Admin" width="700"/>
</p>

* Click **Approve** to approve the Project Developer user.

<p align="center">
<img src="./Assets/Images/PD_Onboarding/image8.png" alt="Click Approve" width="700"/>
</p>
...
<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image1.png" alt="Create User" width="700"/>
</p>

* Select the newly created virtual user from **Users** dropdown.
<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image2.png" alt="Select User" width="700"/>
</p>

* Assign **VVB** role to the virtual user. 

<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image3.png" alt="Assign VVB Role" width="700"/>
</p>

* Fill in the VVB User Onboarding form and submit it.

<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image4.png" alt="Fill in Schema" width="700"/>
</p>

* You will then be directed to the **Waiting for Approval page.**

<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image5.png" alt="Waiting for Approval" width="700"/>
</p>

* From the Users dropdown, select Administrator.

<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image8.png" alt="Select Admin" width="700"/>
</p>

* Select **Verifier Accounts** field.

<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image6.png" alt="Verifier Account" width="700"/>
</p>

* Click **Approve** to approve the Validation and Verification Body (VVB).
<p align="center">
<img src="./Assets/Images/VVB_Onboarding/image7.png" alt="Verifier Account" width="700"/>
</p>

### Project Form Submission and Approval Process

* From Users dropdown, select the virtual user that was assigned as the Project Developer in previous step. (for example, Virtual User 1)

<p align="center">
<img src="./Assets/Images/project_form_submission/image1.png" alt="Select Virtual User" width="700"/>
</p>

* Click Create button to open a new project form.

<p align="center">
<img src="./Assets/Images/project_form_submission/image2.png" alt="Create" width="700"/>
</p>

* Fill in the Project Form and click Create to submit it.

<p align="center">
<img src="./Assets/Images/project_form_submission/image3.png" alt="Project Form" width="700"/>
</p>

* In the **Assign** section, select a **Validation and Verification Body (VVB)** for the project.

<p align="center">
<img src="./Assets/Images/project_form_submission/image4.png" alt="Select VVB" width="700"/>
</p>

* From the Users dropdown, select the virtual user assigned as the VVB (for example, Virtual User 2).

<p align="center">
<img src="./Assets/Images/project_form_submission/image5.png" alt="Select User" width="700"/>
</p>

* Click **Approve** to approve the Project Form from VVB side.

<p align="center">
<img src="./Assets/Images/project_form_submission/image6.png" alt="Approve" width="700"/>
<img src="./Assets/Images/project_form_submission/image8.png" alt="Approve Done" width="700"/>
</p>

* Now from Users dropdown, select **Administrator**.

<p align="center">
<img src="./Assets/Images/project_form_submission/image7.png" alt="Select Admin" width="700"/>
</p>

* Click Approve to give final approval from the administrator side.

<p align="center">
<img src="./Assets/Images/project_form_submission/image9.png" alt="Approve" width="700"/>
</p>

### Project Development Document Submission and Approval Process
* From **Users** dropdown, select virtual user assigned as Project Developer. (For example, Virtual User 1).

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image1.png" alt="Select PD" width="700"/>
</p>

* From the left-hand menu, select **Project Design Document**.
<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image2.png" alt="Select Field" width="700"/>
</p>

* Click **Create PDD** to start the Project Design Document.

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image3.png" alt="Initiate PDD" width="700"/>
</p>
...
<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image4.png" alt="Fill in PDD" width="700"/>
</p>

*  In the **Assign** section, select a Validation and Verification Body (VVB). 

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image5.png" alt="Select VVB for validation" width="700"/>
</p>

* From Users dropdown, select virtual user assigned as Validation and Verification Body (VVB). (For example, Virtual User 2).

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image6.png" alt="Select PD" width="700"/>
</p>

* Click **Approve** to verify the Project Design Document from Validation and Verification Body (VVB) side.

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image7.png" alt="VVB Approval" width="700"/>
</p>

* From **Users** Dropdown, select the **Administrator**,

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image8.png" alt="Select Admin User" width="700"/>
</p>

* Click **Approve** to verify the Project Design Document from Registry side.

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image9.png" alt="Select Admin User" width="700"/>
</p>

* Submission and Approval Process of Project Design Document is now successfully completed.

<p align="center">
<img src="./Assets/Images/pdd_submission_approval/image10.png" alt="Select Admin User" width="700"/>
</p>
