...
import { ApplicationState, MessageBrokerChannel, mongoForLoggingInitialization, OldSecretManager, PinoLogger, pinoLoggerInitialization, SecretManager } from '@guardian/common';
...
Promise.all([
    ...
    new AISuggestionsDB().configureSecretManager(secretManager);
