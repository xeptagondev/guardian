                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b bg-muted/30">
                            ...
                            <SortableHeader label="Issued" sort-key="totalIssued" align="right" tooltip="Total carbon credits issued across all projects by this developer." :active-sort-key="sortKey as string" :sort-dir="sortDir" @sort="toggleSort($event as any)" />
                            <SortableHeader label="Retired" sort-key="totalRetired" align="right" tooltip="Credits permanently retired (used for offsetting). Retired credits cannot be traded or reused." :active-sort-key="sortKey as string" :sort-dir="sortDir" @sort="toggleSort($event as any)" />
